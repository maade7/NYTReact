		...
		return(
			...
			<div className="container">
				...
				<div className="row">
					...
					<div className="jumbotron" style={{'backgroundImage': 'url(./assets/images/the_new_york_times_logo.gif)', 'backgroundRepeat': 'no-repeat', 'backgroundPosition': 'center', 'backgroundSize': '50% 50%', 'backgroundAttachment': 'fixed'}}>
